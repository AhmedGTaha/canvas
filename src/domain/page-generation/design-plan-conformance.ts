...
export function checkDesignPlanConformance(plan: PageDesignPlan, manifest: GeneratedPageManifest): ConformanceResult {
  ...
  if (wantsDominantMedia && manifest.referencedMediaIds.length === 0) {
