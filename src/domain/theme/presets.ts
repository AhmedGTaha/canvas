 ...
 * plus the five design scales, so applying one changes how a website is shaped as well as
 * how it is coloured. They are ordinary theme values — applying a preset writes exactly
 * what the Design panel writes, through the same project theme service, and every field
 * stays editable afterwards. Generated pages never see a preset: they consume the
 * resolved project tokens like any other theme.
 *
...
export const THEME_PRESETS: readonly ThemePreset[] = Object.freeze([
  {
    id: "canvas-neutral",
    name: "Canvas Neutral",
    description: "Near-black type on white with a confident blue accent. The safe default for any business.",
    tone: "restrained",
    theme: {
  ...
  },
  {
    id: "nordic-slate",
    name: "Nordic Slate",
    description: "Cool greys and a steady steel blue. Roomy and quiet — consultancies, studios, B2B.",
    tone: "restrained",
    theme: {
  ...
  },
  {
    id: "editorial-ink",
    name: "Editorial Ink",
    description: "Square corners, large type, almost no shadow. Reads like a printed page.",
    tone: "restrained",
    theme: {
  ...
  },
  {
    id: "atlantic",
    name: "Atlantic",
    description: "Deep navy with a teal accent. Corporate without being cold.",
    tone: "restrained",
    theme: {
  ...
  },
  {
    id: "evergreen",
    name: "Evergreen",
    description: "Forest greens on warm paper. Growers, clinics, sustainability, outdoors.",
    tone: "restrained",
    theme: {
  ...
  },
  {
    id: "monogram",
    name: "Monogram",
    description: "One accent, hairline borders, generous air. Architecture, design, high-end services.",
    tone: "restrained",
    theme: {
  ...
  },
  {
    id: "terracotta",
    name: "Terracotta",
    description: "Clay, sand and soft shadow. Hospitality, interiors, artisan trades.",
    tone: "warm",
    theme: {
  ...
  },
  {
    id: "saffron",
    name: "Saffron",
    description: "Charcoal, cream and a saffron accent. Built for menus, food and drink.",
    tone: "warm",
    theme: {
  ...
  },
  {
    id: "rose-quartz",
    name: "Rose Quartz",
    description: "Soft pinks on warm white, rounded and light. Boutiques, salons, wellness.",
    tone: "warm",
    theme: {
  ...
  },
  {
    id: "oceanic",
    name: "Oceanic",
    description: "Bright cyan on deep blue-grey. Software, data, anything that should feel current.",
    tone: "expressive",
    theme: {
  ...
  },
  {
    id: "graphite-lime",
    name: "Graphite Lime",
    description: "Industrial greys cut by an electric lime. Engineering, motorsport, fabrication.",
    tone: "expressive",
    theme: {
  ...
  },
  {
    id: "plum-velvet",
    name: "Plum Velvet",
    description: "Deep plum, gold accent, lifted surfaces. Events, hotels, premium retail.",
    tone: "expressive",
    theme: {
  ...
  },
  {
    id: "sunrise-coral",
    name: "Sunrise Coral",
    description: "Coral and warm ink, big rounded shapes. Consumer brands with something to say.",
    tone: "expressive",
    theme: {
  ...
  },
  {
    id: "midnight-neon",
    name: "Midnight Neon",
    description: "Dark-first with a violet glow. Nightlife, music, launches — loud on purpose.",
    tone: "expressive",
    theme: {
